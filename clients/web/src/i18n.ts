...
const zh = {
  ...
  "agent.choiceTitle": "它在问你",
  "agent.choiceSubmit": "提交回答",
  "agent.choicePending": "还有问题没选",

  /* ---------- 聊天视图 ---------- */
  "chat.open": "聊天视图",
  "chat.backToTerminal": "终端视图",
  "chat.empty": "这个会话还没有消息",
  "chat.thinking": "思考过程",
  "chat.toolResultError": "失败",
  "chat.openTerminalInstead": "用终端打开",
  "chat.fallback.disabled": "服务端没有开启聊天视图(config.toml 里的 agents.transcript_enabled)",
  "chat.fallback.noPath": "还没拿到这个会话的对话记录位置 —— 它可能刚开始,或者 hook 没装",
  "chat.fallback.unsupported": "这个 AI 的对话记录暂时还读不了",
  "chat.fallback.unreadable": "读不到对话记录",
  "chat.fallback.parseFailed": "对话记录的格式看不懂",
...
const en: Record<MsgKey, string> = {
  ...
  "agent.choiceTitle": "It is asking you",
  "agent.choiceSubmit": "Send answer",
  "agent.choicePending": "Some questions are unanswered",

  /* ---------- chat view ---------- */
  "chat.open": "Chat view",
  "chat.backToTerminal": "Terminal view",
  "chat.empty": "No messages in this session yet",
  "chat.thinking": "Thinking",
  "chat.toolResultError": "failed",
  "chat.openTerminalInstead": "Open the terminal instead",
  "chat.fallback.disabled": "The server has the chat view turned off (agents.transcript_enabled in config.toml)",
  "chat.fallback.noPath": "No transcript location for this session yet — it may have just started, or hooks are not installed",
  "chat.fallback.unsupported": "This agent's transcript cannot be read yet",
  "chat.fallback.unreadable": "Could not read the transcript",
  "chat.fallback.parseFailed": "The transcript format was not understood",
